        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="inline-flex items-center space-x-2 bg-primary/10 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-foreground">{t('about.hero.badge')}</span>
            </div>

            <h1 className="font-headlines text-4xl lg:text-5xl font-bold text-foreground mb-6 leading-tight">
            ...
            <div className="grid grid-cols-3 gap-8 border-t border-border pt-8">
              <div>
                <div className="font-headlines text-3xl font-bold text-primary mb-1">4+</div>
                <div className="text-sm text-muted-foreground">{t('about.hero.stats.experience')}</div>
              </div>
              <div>
                <div className="font-headlines text-3xl font-bold text-primary mb-1">30+</div>
                <div className="text-sm text-muted-foreground">{t('about.hero.stats.students')}</div>
              </div>
              <div>
                <div className="font-headlines text-3xl font-bold text-primary mb-1">100%</div>
                <div className="text-sm text-muted-foreground">{t('about.hero.stats.satisfaction')}</div>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl">
              ...
              {/* Floating Card */}
              <div className="absolute bottom-6 left-6 right-6 z-20 bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-lg border border-white/20">
